...
The module at `src/lib/bounty/voting.ts` SHALL export a pure function
...
- **WHEN** a bounty has `totalPledgedSats: 10000` and one voter with 10000 sats
...
- **WHEN** a bounty has `totalPledgedSats: 10000` (quorum = 5000) and one voter
