...
<nav
	class="fixed inset-x-0 bottom-0 z-50 overflow-hidden border-t border-border bg-card pb-[env(safe-area-inset-bottom)] sm:hidden"
	...
	<div class="flex items-center justify-around">
		{#each items as item}
			<button
				...
				class="flex min-h-[44px] min-w-[44px] cursor-pointer flex-col items-center justify-center gap-0.5 px-3 py-2 text-xs transition-colors
